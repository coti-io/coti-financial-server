...
[![GitHub Stars](https://img.shields.io/github/stars/coti-io/coti-financial-server.svg)](https://github.com/coti-io/coti-financial-server/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/coti-io/coti-financial-server.svg)](https://github.com/coti-io/coti-financial-server/issues)
[![Current Version](https://img.shields.io/badge/version-1.5.0.RELEASE-green.svg)](https://github.com/coti-io/coti-financial-server/)
...
java -jar financialserver/target/financialserver-1.5.0.RELEASE.jar --spring.config.additional-location=financialserver.properties
```
#### Docker container
